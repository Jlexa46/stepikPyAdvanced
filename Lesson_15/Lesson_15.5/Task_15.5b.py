...
def is_modulo_2(__num):
    return __num, len(str(__num)) == 3 and __num % 5 == 2


numbers = map(is_modulo_2, numbers)
print(*[e[0]**3 for e in filter(lambda x: x[0] if x[1] else '', numbers)], sep='\n')
